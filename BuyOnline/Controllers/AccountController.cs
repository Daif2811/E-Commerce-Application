...
namespace BuyOnline.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewBag.UserType = new SelectList(db.Roles.Where(a => !a.Name.Contains("Admins")), "Name", "Name");
            return View();
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ViewBag.UserType = new SelectList(db.Roles.Where(a => !a.Name.Contains("Admins")), "Name", "Name",model.UserType);
        ...
        public ActionResult EditProfile(EditProfileViewModel profile)
        {
            ...
            {
                ViewBag.Message = "This password is wrong";
            }
            else
            {
